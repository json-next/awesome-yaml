...
- [`nika`](https://github.com/supernovae-st/nika) - AI workflow engine with a YAML DSL — `infer`/`exec`/`invoke`/`agent` steps as a reviewable DAG, statically checked before execution (single Rust binary)
